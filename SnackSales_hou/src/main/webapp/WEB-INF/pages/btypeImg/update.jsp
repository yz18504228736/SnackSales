...
<div class="pageContent">
    <form:form method="post" commandName="btypeImg" modelAttribute="btypeImg" action="../btypeImg/update" cssClass="pageForm required-validate"
               enctype="multipart/form-data" onsubmit="return iframeCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <form:hidden path="btypeImgId"></form:hidden>
            <p>
                <label>商品图片：</label>
