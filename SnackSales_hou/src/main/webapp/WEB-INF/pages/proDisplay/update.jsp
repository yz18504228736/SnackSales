...
<div class="pageContent">
    <form:form method="post" commandName="proDisplay" modelAttribute="proDisplay" action="../proDisplay/update" cssClass="pageForm required-validate"
               enctype="multipart/form-data" onsubmit="return iframeCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <form:hidden path="proDisplayId"></form:hidden>
            <p>
                <label>商品图片：</label>
