...
<div class="pageContent">
    <form:form method="post" commandName="proDetail" modelAttribute="proDetail" action="../proDetail/update" cssClass="pageForm required-validate"
               enctype="multipart/form-data" onsubmit="return iframeCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <form:hidden path="proDetailId"></form:hidden>
            <p>
                <label>商品图片：</label>
