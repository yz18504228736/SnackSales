...
<div class="pageContent">
    <form:form method="post" modelAttribute="mangener" action="../mangener/add" cssClass="pageForm required-validate"
               enctype="multipart/form-data"     onsubmit="return iframeCallback(this, navTabAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <p>
                <label>管理员名字：</label>
                 <form:input path="manName"  cssClass="required"></form:input>
            </p>
            <p>
                <label>管理员密码：</label>
                <form:input path="manPwd"  cssClass="required"></form:input>
            </p>
            <!--
            <p>
                <label>上传图片：</label>
