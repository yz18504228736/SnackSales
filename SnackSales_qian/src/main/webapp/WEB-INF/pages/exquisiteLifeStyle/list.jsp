...
<head>
    ...
    <script type="text/javascript" async="" src="exquisiteLifeStyle_files/dc.js">

    </script><script type="text/javascript" async="" src="exquisiteLifeStyle_files/yiguoStats.min.js">

</script><script charset="utf-8" type="text/javascript" src="exquisiteLifeStyle_files/pckit.js"></script>

    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>优质生活（上海）_零食在售Yiguo网_全球精选_生鲜果蔬 品质食材_零食在售网yiguo.com</title>
    <meta name="Keywords" content="水果,进口水果,国产水果,蔬菜,肉类,海鲜,禽蛋,粮油,甜点,葡萄酒,零食在售网">
    <meta name="Description" content="零食在售Yiguo网是专业的进口生鲜水果食品网络购物平台，为您精选全球3000多种生鲜果蔬品质食材，在体验网上购物新模式的同时享尽各国新鲜美味，零食在售网是您悠悦生活的品质之选。">
    ...
    <link rel="dns-prefetch" href="">
    <link rel="dns-prefetch" href="">
    <link href="exquisiteLifeStyle_files/public.css" rel="stylesheet" type="text/css">
    <link href="exquisiteLifeStyle_files/customer.css" rel="stylesheet" type="text/css">
    <link href="exquisiteLifeStyle_files/pageguide.css" rel="stylesheet" type="text/css">


    <style>
        .product .customtag { position: absolute; top: 10px; left: 10px; height: 46px; padding: 0 10px; font: normal 16px/46px "Microsoft YaHei"; -moz-border-radius: 0 10px 10px 10px; -webkit-border-radius: 0 10px 10px 10px; border-radius: 0 10px 10px 10px; color: #fff; background: #e9302b; }
    </style>
    <link href="exquisiteLifeStyle_files/preActivity.css" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" async="" charset="utf-8" src="exquisiteLifeStyle_files/core.php"></script><script type="text/javascript" charset="utf-8" async="" src="exquisiteLifeStyle_files/dplus.php"></script><script src="exquisiteLifeStyle_files/jquery.js"></script>
    <script>
        yg_x = new Date();
        var yw_data = {};
    </script>
    ...
    <!-- end Dplus -->
    <script type="text/javascript" src="exquisiteLifeStyle_files/ygm.dplus-0.5.js"></script>
...
<div class="w">
    ...
    <div class="activity" style="background:url(http://img06.yiguoimg.com/e/others/160311/9288692846764139.jpg) no-repeat top center #efefef;">
        <table>
            <tbody>
            <tr>
                <td>
                    <img id="bannerurl" src="exquisiteLifeStyle_files/9288692845060203.jpg" alt="">
                </td>
            </tr>
            <tr><td><div class="space"></div></td></tr>
            <tr style="background: url(http://img07.yiguoimg.com/e/others/160311/9288692846141547.jpg) no-repeat center top; ">
                <td>
                    <div class="list " id="f1">
                        <img class="lazy"  src="exquisiteLifeStyle_files/9288692846076011.jpg" style="display: block;">
                        <ul>
                      <c:forEach var="exquisiteLifeStyle" items="${list7}">
                        <li class="product j_product">
                            <div class="img"><a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank"><img class="j_product_img lazy"  src="shows/${exquisiteLifeStyle.lifeStyleImg.lifestyleImgName}" style="display: block;"></a></div>
                            <div class="name">
                                <a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank">${exquisiteLifeStyle.product.productName}</a>
                            </div>
                            <div class="price">¥<strong>${exquisiteLifeStyle.product.productPrice}</strong><del></del></div>
                            <div class="buy">
            ...
            <tr style="background: url(http://img06.yiguoimg.com/e/others/160311/9288692846436459.jpg) no-repeat center top; ">
                <td>
                    <div class="list " id="f2">
                        <img class="lazy"  src="exquisiteLifeStyle_files/9288692846338155.jpg" style="display: block;">
                        <ul>
                        <c:forEach var="exquisiteLifeStyle" items="${list8}">
                            <li class="product j_product">
                                <div class="img"><a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank"><img class="j_product_img lazy"  src="shows/${exquisiteLifeStyle.lifeStyleImg.lifestyleImgName}" style="display: block;"></a></div>
                                <div class="name">
                                    <a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank">${exquisiteLifeStyle.product.productName}</a>
            ...
            <tr style="background: url(http://img07.yiguoimg.com/e/others/160311/9288692846567531.jpg) no-repeat center top; ">
                <td>
                    <div class="list " id="f3">
                        <img class="lazy"  src="exquisiteLifeStyle_files/9288692846501995.jpg" style="display: block;">
                        <ul>
                            <c:forEach var="exquisiteLifeStyle" items="${list9}">
                                <li class="product j_product">
                                    <div class="img"><a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank"><img class="j_product_img lazy"  src="shows/${exquisiteLifeStyle.lifeStyleImg.lifestyleImgName}" style="display: block;"></a></div>
                                    <div class="name">
                                        <a href="product/findProduct/${exquisiteLifeStyle.product.productId}" target="_blank">${exquisiteLifeStyle.product.productName}</a>
        ...
        <div class="wrap">
            <dl class="col1">
                ...
                <dd>
                    ...
                    <p><a href="">订购方式</a></p>
                    <p><a href="">悠币说明</a></p>
                    <p><a href="">会员等级<i class="ml5" style="display: none;"><img src="newarrival_files/icon-new.png"></i></a></p>
            ...
            <div class="copyright">
                ...
                <p> <a href="" target="_blank" rel="nofollow">沪ICP备09008015号 </a>  Copyright © 2005-2017 <a href="">上海零食在售电子商务有限公司</a>版权所有</p>
                <p class="authentication">
                    <a href="" target="_blank" rel="nofollow"><img src="newarrival_files/153685368061665897_121x29.png" style="height:29px;"></a>
                    <a href="" target="_blank" rel="nofollow"><img src="newarrival_files/2517491005058doc.png" height="47"></a>
                    <a href="" target="_blank"><img src="newarrival_files/footer_copy.gif" width="47px" height="47px"></a>
                    <a target="_blank" href="" style="display: inline-block; text-decoration: none; height: 20px; line-height: 20px;"><img src="newarrival_files/ghs.png" style="float: left;"><span style="float: left; height: 20px; line-height: 20px; margin: 0px 0px 0px 5px; color: #939393;">沪公网安备 31010502000002号</span></a>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="sidebar" id="sidebar">
        <a href="javascript:void(0);" class="s-btn service" id="calltool_1508923114281"></a>
        <a href="" class="s-btn goTop" style="display: none;"></a>
    </div>
</div>

<script src="exquisiteLifeStyle_files/jquery.cookie.js"></script>
<script src="exquisiteLifeStyle_files/handlebars-v3.0.1.js"></script>
<script src="exquisiteLifeStyle_files/utaste.js"></script>
<script src="exquisiteLifeStyle_files/base.js"></script>
<script src="exquisiteLifeStyle_files/jquery.superslide.js"></script>
<script src="exquisiteLifeStyle_files/sidebar.js"></script>
<script src="exquisiteLifeStyle_files/floor-guide.js"></script>
<script src="exquisiteLifeStyle_files/global-v2.js"></script>
<script src="exquisiteLifeStyle_files/search.js"></script>
<script src="exquisiteLifeStyle_files/city.js"></script>
<script src="exquisiteLifeStyle_files/app.js"></script>
<script src="exquisiteLifeStyle_files/common.js"></script>
<script src="exquisiteLifeStyle_files/util.js"></script>
<!--[if lt IE 9]>
<script src="https://g.alicdn.com/aliww/ww/json/json.js" charset="utf-8"></script>
<![endif]-->
<!-- 自动适配移动端与pc端 -->
<script src="exquisiteLifeStyle_files/saved_resource" charset="utf-8"></script>
<script src="exquisiteLifeStyle_files/chat.js"></script>
<script>
    $(function () {
        app.init();
...
<script src="exquisiteLifeStyle_files/stats.js"></script>


<script type="text/javascript" src="exquisiteLifeStyle_files/jquery.lazyload.js"></script>
<script type="text/javascript" src="exquisiteLifeStyle_files/falleve.js"></script>
...
<div class="popout Dailog-poput" style="z-index:999999999;display:none;"><div class="popout-wrap">
    <div class="popout-con">            	                <div class="title"><i></i>提 示</div>            	                <div class="con">            		                <p style="text-align: center; font-size: 14px; padding-top: 15px;"></p>                                    <div class="btnbox" style="margin-top: 45px;"><a class="confirm" href="javascript:">确定</a></div>            	                </div>                            </div>                        </div>                        <div class="popout-bg">&nbsp;</div></div></body></html>