...
<!DOCTYPE html>
<!-- saved from url=(0084)http://home.yiguo.com/Trade/OrderDetail?orderId=2ce2be7b-349b-4a02-a113-1a6302199c55 -->
<html><head>
    ...
    <link href="orderDetail_files/yg.css" rel="stylesheet" type="text/css">
    <link href="orderDetail_files/search.css" rel="stylesheet" type="text/css">
    <script charset="utf-8" src="orderDetail_files/v.js.下载"></script><script type="text/javascript" async="" src="orderDetail_files/dc.js.下载"></script><script type="text/javascript" async="" src="orderDetail_files/yiguoStats.min.js.下载"></script><script type="text/javascript" id="veConnect" async="" crossorigin="anonymous" src="orderDetail_files/capture-apps-4.20.1.js.下载"></script><script type="text/javascript" async="" src="orderDetail_files/collect.js.下载"></script><script type="text/javascript" async="" charset="utf-8" src="orderDetail_files/core.php"></script><script type="text/javascript" async="" src="orderDetail_files/vds.js.下载"></script><script type="text/javascript" async="" src="orderDetail_files/adw.js.下载"></script><script src="orderDetail_files/tm.js.下载" async=""></script><script type="text/javascript" charset="utf-8" async="" src="orderDetail_files/dplus.php"></script><script src="orderDetail_files/jquery-1.7.2-min.js.下载"></script>
    <link href="orderDetail_files/returns.css" rel="stylesheet" type="text/css">

    <link href="orderDetail_files/yg.css" rel="stylesheet" type="text/css">
    <link href="orderDetail_files/myorder.css" rel="stylesheet" type="text/css">


    <link href="orderDetail_files/themes.css" rel="stylesheet" type="text/css">
    ...
    <script src="orderDetail_files/topdsp.js.下载"></script><script type="text/javascript" async="" src="orderDetail_files/tag.js.下载"></script>
</head>
<body id="body">
<!------- 弹出框 ------->
<div class="w">
                ...
                <div class="catalogs-list" id="_categry" style="display:none;">
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/01_channelhome.html"><img src="orderDetail_files/9570160763248445.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/02_channelhome.html"><img src="orderDetail_files/9570160763379517.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/05_channelhome.html"><img src="orderDetail_files/9570160763445053.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/06_channelhome.html"><img src="orderDetail_files/9570160763510589.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/04_channelhome.html"><img src="orderDetail_files/9570160763576125.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/08_channelhome.html"><img src="orderDetail_files/9570160763641661.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/03_channelhome.html"><img src="orderDetail_files/9570161550040894.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/10_channelhome.html"><img src="orderDetail_files/9570160763838269.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/07_channelhome.html"><img src="orderDetail_files/9570160757940029.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/09_channelhome.html"><img src="orderDetail_files/9570160763182909.png"></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        ...
                        <div class="sub-item" style="display: none;">
                            ...
                            <div class="catalogs-ad">
                                <a href="http://www.yiguo.com/products/11_channelhome.html"><img src="orderDetail_files/9570160763903805.png"></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="content myyg">
            ...
            <div class="main order-detail">
                ...
                <div class="order-state clearfix">
                    <dt>
                        <span>订单号：${detaiList.get(0).orderName}</span><span>状态：<b>${detaiList.get(0).orderState.stateName}</b></span>
                ...
                <div class="order-info clearfix">
                    ...
                    <div>
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    <li>收货人:${detaiList.get(0).receiverName}</li>
                                    <li>地&nbsp;&nbsp;&nbsp;址:${detaiList.get(0).address}</li>
                                    <li>手机号:${detaiList.get(0).phonenum}</li>
                                </ul>
                            </dd>
                        </dl>
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    <li>运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费：￥${detaiList.get(0).fee}</li>
                                    <li>送货日期：${detaiList.get(0).orderTime}</li>
                                    <li>配送时间：全天09:00-21:00</li>
                                </ul>
                            </dd>
                        </dl>
                            ...
                            <dd class="order-goos">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th width="125">数量</th>
                                        <th width="125">规格</th>
                                        <th width="125">金额小计</th>
                                    </tr>
                                    <c:forEach items="${detaiList}" var="detail">
                                        <tr class="j_product">
                                            <td>${detail.orderName}</td>
                                            <td><a class="img" href="product/findProducts/${detail.orderProName}" target="_blank"><img class="j_product_img" width="22" height="22" src="shows/${detail.orderProImg}">
                                                ${detail.orderProName}
                                                <p class="gray2">不支持7天无理由退货</p>
                                            </a></td>
                                            <td>￥${detail.orderProPrice}</td>
                                            <td>${detail.orderProNum}件</td>
                                            <td>${detail.orderProSize}</td>
                                            <td>￥${detail.orderProNum*detail.orderProPrice}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <div class="order-total">
                        <ul>
                            <li><span>商品总金额：</span>￥${price}</li>
                            <li><span>运费：</span>${detaiList.get(0).fee}</li>
                            <li><span>支付宝：</span>￥${totalPrice}</li>

                        </ul>
                        <div class="clear"></div>
                        <div class="extra">
                            应付金额：<span><b>￥${totalPrice}</b></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="wrap">
            <dl class="col1">
                ...
                <dd>
                    ...
                    <p><a href="http://www.yiguo.com/activity/sale/2999">会员等级<i class="ml5" style="display: none;"><img src="orderDetail_files/icon-new.png"></i></a></p>
            ...
            <div class="copyright">
                ...
                <p class="authentication">
                    ...
                    <a href="https://180.169.127.46:9090/?sn=310100102001">
                        <img src="orderDetail_files/picp_bg.png" alt="»¦¹«θ±¸" border="0">
    ...
    <div style="display: none">
        ...
        </script><script src="orderDetail_files/h.js.下载" type="text/javascript"></script><a href="http://tongji.baidu.com/hm-web/welcome/ico?s=36a486fbdec46fc52ca666dd2e98f260" target="_blank"><img border="0" src="orderDetail_files/21.gif" width="20" height="20"></a>
    </div>
    <!------- 侧边悬浮 ------->
    <div class="sidebar" id="sidebar">
        <a href="javascript:void(0);" class="s-btn service" id="calltool_1509508423175"></a>
        <a href="http://home.yiguo.com/Trade/OrderDetail?orderId=2ce2be7b-349b-4a02-a113-1a6302199c55#body" class="s-btn goTop"></a>
    </div>
</div><script type="text/javascript" id="">var _smq = _smq || []; _smq.push(['_setAccount', '62b87db', new Date()]); _smq.push(['pageview']); (function() { var sm = document.createElement('script'); sm.type = 'text/javascript'; sm.async = true; sm.src = ('https:' == document.location.protocol ? 'https://' : 'http://') + 'site.cdnmaster.cn/sitemaster/collect.js'; var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(sm, s); })(); </script><iframe src="orderDetail_files/_adw.html" id="emar_box_pv" style="width: 1px; border: 0px; position: absolute; left: -100px; top: -100px; height: 1px;"></iframe>
<script src="orderDetail_files/handlebars-v3.0.1.js.下载"></script>
<script src="orderDetail_files/jquery.superslide.js.下载"></script>
<script src="orderDetail_files/utaste.js.下载"></script>
<script src="orderDetail_files/sidebar.js.下载"></script>
<script src="orderDetail_files/jquery.scrollLoading-min.js.下载"></script>
<script src="orderDetail_files/search.js.下载"></script>
<script src="orderDetail_files/global-v2.js.下载"></script>
<script src="orderDetail_files/base.js.下载"></script>
<script src="orderDetail_files/app.js.下载"></script>
<script src="orderDetail_files/common.js.下载"></script>


<script src="orderDetail_files/util.js.下载"></script>
<script src="orderDetail_files/city.js.下载"></script>
<!--[if lt IE 9]>
<script src="https://g.alicdn.com/aliww/ww/json/json.js" charset="utf-8"></script>
<![endif]-->
<!-- 自动适配移动端与pc端 -->
<script src="orderDetail_files/saved_resource" charset="utf-8"></script>
<script src="orderDetail_files/chat.js.下载"></script>
...
<div class="popout Dailog-poput" style="z-index:999999999;display:none;"><div class="popout-wrap">                            <div class="popout-con">            	                <div class="title"><i></i>提 示</div>            	                <div class="con">            		                <p style="text-align: center; font-size: 14px; padding-top: 15px;"></p>                                    <div class="btnbox" style="margin-top: 45px;"><a class="confirm" href="javascript:">确定</a></div>            	                </div>                            </div>                        </div>                        <div class="popout-bg">&nbsp;</div></div><iframe id="veUtilsIframe" width="0" height="0" style="visibility: hidden; display: none; border: none;" src="orderDetail_files/saved_resource.html"></iframe><iframe id="1509508423250" tabindex="-1" src="orderDetail_files/iframeStorage.html" style="display: none;"></iframe></body></html>