...
<!DOCTYPE html>
<!-- saved from url=(0037)http://home.yiguo.com/Trade/OrderList -->
<html>
<head>
...
<div class="w">
        ...
        <div class="wrap">
            ...
            <div class="search" style="position:relative;">
                ...
                <div class="search-keywords" id="keywords">
                    ...
                    <a href="http://home.yiguo.com/Trade/OrderList" target="_blank"></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="header-nav">
        <div class="wrap">
            <!--商品分类 开始-->
            <div class="catalogs">
                <div class="catalogs-title btn-green"><a href="http://home.yiguo.com/Trade/OrderList#"><i></i>全部商品分类</a></div>
    ...
    <div class="wrap">
        <!--面包屑-->
        <div class="crumbs"><a class="ml0" href="">首页</a>&gt;<a href="" class="j_ygnav">我的零食在售</a><span class="j_thridcrumbs hide">&gt;<a href="javascript:void(0)" class="on j_thirdnav">我的订单</a></span></div>
                        ...
                        <ul class="j_allorderli">
                            ...
                            <li>
                                <table class="order-list j_product">
                                    <thead>
                                    <tr>
                                        <th colspan="4"><div><span>订单号：${orders.orderName}</span><span>提交时间：${orders.date}</span></div></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td width="520" class="all-goods">
                                            <c:forEach items="${orders.nameImg}" var="proName">
                                            <a href="product/findProduct/${proName.proId}" target="_blank">
                                            <img class="j_product_img" src="shows/${proName.proImg}"></a>
                                            </c:forEach>
                                            <div class="m"><div>共计${orders.count}件商品</div></div>
                                        </td>
                                        <td class="amount" width="140">${orders.price}</td>
                                        <td width="140">${orders.orderState.stateName}</td>
                                        <td width="140" class="operate">
                                            <div>
                                                <a target="_blank" href="orders/detail?orderName=${orders.orderName}">查看详情</a>
                                                <a href="orders/delete?orderName=${orders.orderName}">删除</a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
