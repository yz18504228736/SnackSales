        ...
        <div class="main profile">
            <form id="personalProfileForm" method="post" action="user/update" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    ...
                    <div class="controls" id="imgDiv">
                        ...
                        <c:if test="${user.userImg==null}">
                            <input type="file" id="usersImg" name="img" style="display: none">
                            <img style=" width:100px; height:100px;" src="personInfo_files/Avatar.jpg" onclick="uploadImg()">
                        </c:if>
                        <c:if test="${user.userImg!=null}">
                            <input type="file" id="usersImg" name="img" style="display: none">
                            <img style=" width:100px; height:100px;" src="shows/${user.userImg}" onclick="uploadImg()">
                        </c:if>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                             <span class="EidtGroup">
                              <c:if test="${user.userTruename==null}">
                                  <input class="input" id="RealName" name="userTruename" placeholder="请输入您的真实姓名" type="text">
                              </c:if>
                              <c:if test="${user.userTruename!=null}">
                                  <input class="input" id="RealName" name="userTruename" placeholder="${user.userTruename}" type="text">
                              </c:if>
                             <span class="pass-tip"><i></i>长度不能超过10个汉字</span>
                            </span>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                            ...
                            <c:if test="${user.userName==null}">
                                <input id="UserName" name="userName" type="text" placeholder="${user.userTel}">
                            </c:if>
                            <c:if test="${user.userName!=null}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                            <span class="EidtGroup">
                            <input id="userTel" name="userTel" type="hidden" value="${user.userTel}">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                                <span class="EidtGroup">
                                <input type="text" name="userMail" placeholder="${user.userMail}">
                                </span>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label><input data-val-required="Sex 字段是必需的。" id="sex1" name="userSex" type="radio" value="男">男</label>
                        <label><input data-val-required="Sex 字段是必需的。" id="sex2" name="userSex" type="radio" value="女">女</label>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-label">生日</div>
                    <div class="controls IsEditYear" data-edit="1">
                        <input type="date" class="Birthday" data-val="true" name="userBirth" value="${user.userBirth}">
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls"><button type="submit" class="btn-green btn-green-l">确 &nbsp; 认</button></div>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    ...
    function uploadImg()
    {
        document.getElementById("usersImg").click();
    }
    document.getElementById('usersImg').onchange = function() {
        var imgFile = this.files[0];
        var fr = new FileReader();
        fr.onload = function() {
            document.getElementById('imgDiv').getElementsByTagName('img')[0].src = fr.result;
        };
