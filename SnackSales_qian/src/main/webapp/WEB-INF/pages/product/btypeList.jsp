...
<div class="w">
    ...
    <div class="wrap">
        ...
        <div class="page_ad clearfix">
            <a class="big" href="" target="_blank"><img src="shows/${btypeImgList.get(0).btypeName}" width="1200" height="300"></a>
            <a class="medium mr" href="" target="_blank"><img src="shows/${btypeImgList.get(1).btypeName}" width="405" height="180"></a>
            <a class="medium mr" href="" target="_blank"><img src="shows/${btypeImgList.get(2).btypeName}" width="405" height="180"></a>
            <a class="small mr" href="" target="_blank"><img src="shows/${btypeImgList.get(3).btypeName}" width="180" height="180"></a>
            <a class="small" href="" target="_blank"><img src="shows/${btypeImgList.get(4).btypeName}" width="180" height="180"></a>
        </div>
        ...
        <div class="goods_list clearfix" _category="01_channelhome" _page="2" _end="false" _maxpage="4">
            <ul>
                <c:forEach items="${btypeListVoList}" var="btype">
                    <li class="product_item j_product" _type="0" _productid="1271965">
                        <div class="p_img clearfix">
                            ...
                            <a href="product/findProduct/${btype.proId}" target="_blank">
                                <img src="shows/${btype.proImg.proDisplayImg}" width="290" height="290" class="j_product_img">

                            </a>
                        </div>
                        <div class="p_info clearfix">
                            <div class="p_name"><a href="product/findProduct/${btype.proId}" target="_blank">${btype.proName}</a></div>
                            <div class="p_price">
                                <span class="price">
                                    <strong>¥${btype.proPrice}</strong>
                                </span>
                            </div>
                        </div>
                        <div class="p-buy">
