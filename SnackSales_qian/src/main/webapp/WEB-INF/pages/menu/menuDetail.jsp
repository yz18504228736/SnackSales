...
<html>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script type="text/javascript" async="" src="js/dc.js.下载"></script>
    ...
    <script type="text/javascript" async="" src="js/yiguoStats.min.js"></script><script type="text/javascript" async="" src="js/collect.js.下载"></script><script type="text/javascript" async="" src="js/vds.js.下载"></script><script type="text/javascript" async="" src="js/adw.js.下载"></script><script src="js/tm.js.下载" async=""></script><script>
        yg_x = new Date();
    </script>
...
<div class="w">
    ...
    <div class="wrap">
        <div class="recipe">
            ...
            <div class="crumbs">
                ...
                &gt;<a href="">${menu.menutype.menuTypeName}</a>
                &gt;<a class="on" href="javascript:void(0)">${menu.menuName}</a>
            </div>
            <div class="recipe-intro floor clearfix" id="f-intro">
                <div class="pic">
                    <img width="500" height="500" src="shows/${menu.menuImg}">
                </div>
                <div class="recipe-info">
                    <h1>${menu.menuName}</h1>
                    <div class="tag"><span>${menu.menutype.menuTypeName}</span></div>
                    <p class="introduce">${menu.menuDesc}</p>
                    <div class="related">
                    </div>
                </div>
            </div>
            <div class="recipe-main clearfix">
                <input type="hidden" id="articleId" value="f21ab7de-8f6d-489d-8abc-90489ac1a46a">
                <div class="main">
                   <div class="menu-food">
    ...
    <script id="recipedetailtpl" type="text/x-handlebars-template">
        {{#data}}
        {{#more Count 0}}
        <h4>精选食材</h4>
        <div class="goods j_goods">
            {{#Commoditys}}
            <div class="product_item">
                {{#equal State 2}}
                <label>
                    <div class="p_img clearfix">
                        <a href="{{CommodityUrl}}" target="_blank"><img src="{{CommodityImgUrl}}" width="290" height="290"></a>
                    </div>
                    <div class="p_info clearfix">
                        <div class="p_name"><a href="{{CommodityUrl}}" target="_blank">{{CommodityName}}</a></div>
                        <div class="p_price">
                            <span class="soldout"><strong>¥{{UnitPrice}}</strong></span>
                        </div>
                    </div>
                </label>
                {{else}}
                <input type="checkbox" id="p-item{{ @index }}" data-id="{{CommodityId}}" data-price="{{UnitPrice}}" checked="checked">
                <label for="p-item{{ @index }}">
                    <div class="p_img clearfix">
                        {{#equal CommodityTag ""}}
                        {{else}}
                        <p class="tag"><img src="{{CommodityTag}}" width="46" height="46"></p>
                        {{/equal}}
                        <a href="{{CommodityUrl}}" target="_blank"><img src="{{CommodityImgUrl}}" width="290" height="290"></a>
                    </div>
                    <div class="p_info clearfix">
                        <div class="p_name"><a href="{{CommodityUrl}}" target="_blank">{{CommodityName}}</a></div>
                        <div class="p_price">
                            <span class="price"><strong>¥{{UnitPrice}}</strong></span>
        ...
        <div class="total">
            <span>一共选择 <b class="j_amount">{{ActualCount}}</b> 种食材</span><span>|</span><span>共计：<strong class="j_price">¥{{TotalPrice}}</strong></span>
            <span><a class="btn-red j_submit" href="javascript:buy()">加入购物车</a></span>
        </div>
        <input type="hidden" id="cids" value="{{CommodityIds}}" />
        {{/more}}
        {{/data}}
    </script>
    ...
    <div class="sidebar" id="sidebar">
        <a href="http://article.yiguo.com/Recipes/Detail/f21ab7de-8f6d-489d-8abc-90489ac1a46a#body" class="s-btn goTop" style="display: none;"></a>
    </div>
...
<div class="popout Dailog-poput" style="z-index:999999999;display:none;"><div class="popout-wrap">                            <div class="popout-con">            	                <div class="title"><i></i>提 示</div>            	                <div class="con">            		                <p style="text-align: center; font-size: 14px; padding-top: 15px;"></p>                                    <div class="btnbox" style="margin-top: 45px;"><a class="confirm" href="javascript:">确定</a></div>            	                </div>                            </div>                        </div>                        <div class="popout-bg">&nbsp;</div></div><iframe src="js/_adw.html" id="emar_box_pv" style="width: 1px; border: 0px; position: absolute; left: -100px; top: -100px; height: 1px;"></iframe></body></html>
