    ...
    <div class="popout-wrap">
        <div class="popout-con">
            ...
            <div class="con">
                <h1>您设置了该商品到货通知！</h1>
                <p>
                    我们会将到货通知信息及时发送到您的邮箱：<br> <a href=""><u></u></a> <a href="http://home.yiguo.com/Trade/CommodityVote#" target="_blank">修改邮箱</a>
                </p>
...
<div class="w">
    ...
    <div class="wrap">
        <!--面包屑-->
        <div class="crumbs"><a class="ml0" href="http://www.yiguo.com/">首页</a>&gt;<a href="http://home.yiguo.com/Trade/Index" class="j_ygnav">我的易果</a><span class="j_thridcrumbs hide">&gt;<a href="javascript:void(0)" class="on j_thirdnav">评论商品</a></span></div>
        <div class="content myyg">
            <div class="sub">
                    ...
                    <dl>
                        ...
                        <dd>
                            <ul>
                                ...
                                <li><a href="address/list/${currentUser.userId}">收货地址管理</a></li>
                            </ul>
                        </dd>
                        <dt>售后服务</dt>
                        <dd>
                ...
                <div>
                    <div class="ad" style="height: 308px;">
                        <a href="" target="_blank" style="display: none"><img src="js/ad.jpg" width="194" height="308"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="main comments">
                <form method="post" action="comment/addComment" style="width: 600px">
                        <div style="width: 100px;height: 100px">
                            <ul>
                                <li><img style="height: 100px ;width: 100px" src="shows/${proDisplayList.get(0).proDisplayImg}"></li>
                                <li name="proName">${product.productName}></li>
                            </ul>
                        </div>
                        <input type="">
                    <div id="star" > <span>评论打分</span>
                        <ul>
                            <li><input name="stars" href="javascript:;"/>1</li>
                            <li><input name="stars" href="javascript:;"/>2</li>
                            <li><input name="stars" href="javascript:;"/>3</li>
                            <li><input name="stars" href="javascript:;"/>4</li>
                            <li><input name="stars" href="javascript:;"/>5</li>
                        </ul>
                        <span></span>
                        <p></p>
                    </div><br/>
                    <textarea name="content" cols="50" rows="25" style="all-space-treatment: 1px">
                    </textarea><br/>
            ...
            <div class="footer" style="margin-top: auto">
                <div class="wrap">
                    ...
                    <div class="copyright">
                        ...
                        <p>版权所有<a href="">上海易果电子商务有限公司</a>  2005-2017 Copyright @ 2005-2017 _www.yiguo.com, All rights reserved 沪ICP备09008015号<br><br></p>
                        <p class="authentication">
                            <a href="" target="_blank" rel="nofollow"><img src="images/153685368061665897_121x29.png" style="height:29px;"></a>
                            <a href="" target="_blank"><img src="myorders_files/footer_copy.gif" width="47px" height="47px"></a>
                            <a href="">
            ...
            <div style="display: none">
                ...
                </script><script src="js/h.js" type="text/javascript"></script><a href="" target="_blank"><img border="0" src="js/21.gif" width="20" height="20"></a>
            </div>
            <!------- 侧边悬浮 ------->
            <div class="sidebar" id="sidebar">
                <a href="javascript:void(0);" class="s-btn service" id="calltool_1509519137777"></a>
                <a href="" class="s-btn goTop"></a>
            </div>
